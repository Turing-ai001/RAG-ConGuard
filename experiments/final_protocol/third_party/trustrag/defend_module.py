# ============================================================
# Verbatim copy of https://github.com/HuichiZhou/TrustRAG/defend_module.py
# commit 11dcea0262d14b0e38e22e1d7ddce4a151e82a61
# INTEGRATION PATCH (only): `from src.utils import progress_bar` replaced
# by a local stub below; no other lines modified.
# ============================================================
...
# # [patch] original import removed (stub above)
